      ...
      <div className="bioContainer">
        <div className="bioTitle">
          ...
          <button className='editBioBTN' onClick={modifyVisible}>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"  className="EditBIOSVG changeSVG" viewBox="0 0 19 19" fill='currentColor'>
                <path  className= "changeSVG"d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
            </svg>
          </button>
        </div>
          <div className="bioContent">
            ...
            <div className="postProfileContainer">
              ...
              <div className="postsContent">
                ...
                )})} </div> : <p className='bioTxt'>You dont have any posts, make one now!</p>}
              </div>
            </div>
